...
OnCompletionListener, OnErrorListener, AudioManager.OnAudioFocusChangeListener
{
	...
	public int onStartCommand(Intent intent, int flags, int startId)
	{
		...
		case ACTION_START:
			...
			unshuffableList = MusicMasterHandler.getToPlay();
			mPlayingMusicas = MusicMasterHandler.getToPlay();break;
		case ACTION_PLAY:mCurrentPlayingPos=MusicMasterHandler.getToPlayPosition();
		handlePlayRequest();
	...
	public boolean shuffle(){
		...
		if(shuffleState){
		Collections.shuffle(MusicMasterHandler.getToPlay());
		mPlayingMusicas=MusicMasterHandler.getToPlay();
		}
		else{
			mPlayingMusicas=unshuffableList;
			MusicMasterHandler.setToPlay(this,unshuffableList);
		}
    ...
    void playCurrentSong()
	{
		...
		try
		{
			mMediaPlayer.setDataSource(this,Uri.parse(mPlayingMusicas.get(mCurrentPlayingPos).getMusicaUri()));
