...
public class MyMusicasHolder extends RecyclerAdapter.Holder
{
	...
	public void feedIt(final Musica m, OnItemClickListener o){
		...
		protected void onPostExecute(Boolean b){
			if(b){
				mTag.setBackgroundColor(ContextCompat.getColor(mNome.getContext(), R.color.grey_500));
			}
			if(b && MusicMasterHandler.isOffline(mNome.getContext(), m)){
